...
public class Paladin extends Classe {
	...
	public void openMenu(Player player) {
		...
		effectUpMeta1.setLore(Arrays.asList("", "§aCoût : §720", "§fPayez avec vos niveaux pour", "§faméliorer vos effets", "§5Prochain effet : §cRésistance 1"));
		...
		effectUpMeta2.setLore(Arrays.asList("", "§aCoût : §730", "§fPayez avec vos niveaux pour", "§faméliorer vos effets", "§5Prochain effet : §cRésistance 2"));
